# Christmas theme for simplecountdown
A theme for simple countdown

#Example with theme
Theme should be specified adding a third parameter to autoDisplay method. For use playa theme, include simplecountdown-theme-christmas.js file in your page:
```javascript
<script type="text/javascript" src="simplecountdown.js"></script>
<script type="text/javascript" src="simplecountdown-theme-christmas.js"></script>
```
...
<script type="text/javascript">
  SimpleCountdown.autoDisplay('myCountdown', '2016-12-25 00:00:00', "christmas");
</script>
```
